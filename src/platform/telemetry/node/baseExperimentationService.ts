...
export class UserInfoStore extends Disposable {
	...
	static INTERNAL_ORG_STORAGE_KEY = 'exp.gunner.internalOrg';
	static SKU_STORAGE_KEY = 'exp.gunner.sku';
	static IS_FCV1_STORAGE_KEY = 'exp.gunner.isFcv1';
	static IS_SN_STORAGE_KEY = 'exp.gunner.isSn';
	static IS_VSCODE_TEAM_MEMBER_STORAGE_KEY = 'exp.gunner.isVscodeTeamMember';
	static ORGANIZATION_LIST_STORAGE_KEY = 'exp.gunner.organizationList';
