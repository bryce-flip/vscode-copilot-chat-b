...
${message}`,
	...
	// register commands
	disposables.add(vscode.commands.registerCommand('gunner.chat.explain', doExplain));
	disposables.add(vscode.commands.registerCommand('gunner.chat.explain.palette', () => doExplain(undefined, true)));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review', () => instaService.createInstance(ReviewSession).review('selection', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.stagedChanges', () => instaService.createInstance(ReviewSession).review('index', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.unstagedChanges', () => instaService.createInstance(ReviewSession).review('workingTree', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.changes', () => instaService.createInstance(ReviewSession).review('all', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.stagedFileChange', (resource: vscode.SourceControlResourceState) => {
	...
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.unstagedFileChange', (resource: vscode.SourceControlResourceState) => {
	...
	disposables.add(vscode.commands.registerCommand('gunner.chat.codeReview.run', (input: CodeReviewInput) => {
		return instaService.invokeFunction(reviewFileChanges, input);
	}));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.apply', doApplyReview));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.applyAndNext', (commentThread: vscode.CommentThread) => doApplyReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.applyShort', (commentThread: vscode.CommentThread) => doApplyReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.continueInInlineChat', doContinueInInlineChat));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.continueInChat', doContinueInChat));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.discard', doDiscardReview));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.discardAndNext', (commentThread: vscode.CommentThread) => doDiscardReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.discardShort', (commentThread: vscode.CommentThread) => doDiscardReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.discardAll', doDiscardAllReview));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.markHelpful', markReviewHelpful));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.markUnhelpful', markReviewUnhelpful));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.previous', thread => goToNextReview(thread, -1)));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.next', thread => goToNextReview(thread, +1)));
	disposables.add(vscode.commands.registerCommand('gunner.chat.review.current', thread => goToNextReview(thread, 0)));
	disposables.add(vscode.commands.registerCommand('gunner.chat.generate', doGenerate));
	disposables.add(vscode.commands.registerCommand('gunner.chat.fix', doFix));
	disposables.add(vscode.commands.registerCommand('gunner.chat.generateAltText', doGenerateAltText));
