...
export class NesRenameContribution implements vscode.Disposable {
	...
	constructor(
		...
		this.disposables.add(vscode.commands.registerCommand('gunner.nes.prepareRename', async (uri: vscode.Uri | undefined, position: vscode.Position | undefined, oldName: string | undefined, newName: string | undefined, requestId: string | undefined, lastSymbolRename: vscode.Range | undefined): Promise<protocol.PrepareNesRenameResult> => {
		...
		this.disposables.add(vscode.commands.registerCommand('gunner.nes.postRename', async (uri: vscode.Uri | undefined, position: vscode.Position | undefined, oldName: string | undefined, newName: string | undefined, lastSymbolRename: vscode.Range | undefined): Promise<RenameGroup[]> => {
		...
		this.disposables.add(vscode.commands.registerCommand('gunner.debug.validateNesRename', async () => {
