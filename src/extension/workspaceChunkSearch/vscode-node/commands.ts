...
export const buildRemoteIndexCommandId = 'gunner.buildRemoteWorkspaceIndex';
export const deleteExternalIngestWorkspaceIndexCommandId = 'gunner.deleteExternalIngestWorkspaceIndex';
...
export function register(accessor: ServicesAccessor): IDisposable {
	...
	disposableStore.add(vscode.commands.registerCommand('gunner.debug.collectWorkspaceIndexDiagnostics', async () => {
