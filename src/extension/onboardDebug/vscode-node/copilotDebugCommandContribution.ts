...
const WAS_REGISTERED_STORAGE_KEY = 'gunner.terminalToDebugging.registered';
...
export class CopilotDebugCommandContribution extends Disposable implements vscode.UriHandler {
	...
	constructor(
		...
		this._register(vscode.commands.registerCommand('gunner.chat.startCopilotDebugCommand', async () => {
