...
const NOTEBOOK_FOLLOW_IN_SESSION_KEY = 'gunner.notebookFollowInSessionEnabled';
...
export class NotebookFollowCommands extends Disposable {
	...
	constructor(
		...
		this._register(vscode.commands.registerCommand('gunner.chat.notebook.enableFollowCellExecution', () => {
			this.updateFollowContext(true);
		}));

		this._register(vscode.commands.registerCommand('gunner.chat.notebook.disableFollowCellExecution', () => {
