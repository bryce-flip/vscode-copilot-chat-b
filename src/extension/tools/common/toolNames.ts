...
export enum ToolName {
	...
	GetNotebookSummary = 'gunner_getNotebookSummary',
...
export enum ContributedToolName {
	ApplyPatch = 'gunner_applyPatch',
	Codebase = 'gunner_searchCodebase',
	SearchWorkspaceSymbols = 'gunner_searchWorkspaceSymbols',
	VSCodeAPI = 'gunner_getVSCodeAPI',
	TestFailure = 'gunner_testFailure',
	/** @deprecated moving to core soon */
	RunTests = 'gunner_runTests1',
	FindFiles = 'gunner_findFiles',
	FindTextInFiles = 'gunner_findTextInFiles',
	ReadFile = 'gunner_readFile',
	ViewImage = 'gunner_viewImage',
	ListDirectory = 'gunner_listDirectory',
	GetErrors = 'gunner_getErrors',
	GetScmChanges = 'gunner_getChangedFiles',
	ReadProjectStructure = 'gunner_readProjectStructure',
	CreateNewWorkspace = 'gunner_createNewWorkspace',
	CreateNewJupyterNotebook = 'gunner_createNewJupyterNotebook',
	EditFile = 'gunner_insertEdit',
	CreateFile = 'gunner_createFile',
	ReplaceString = 'gunner_replaceString',
	MultiReplaceString = 'gunner_multiReplaceString',
	EditNotebook = 'gunner_editNotebook',
	RunNotebookCell = 'gunner_runNotebookCell',
	GetNotebookSummary = 'gunner_getNotebookSummary',
	ReadCellOutput = 'gunner_readNotebookCellOutput',
	InstallExtension = 'gunner_installExtension',
	FetchWebPage = 'gunner_fetchWebPage',
	Memory = 'gunner_memory',
	FindTestFiles = 'gunner_findTestFiles',
	GetProjectSetupInfo = 'gunner_getProjectSetupInfo',
	SearchViewResults = 'gunner_getSearchResults',
	GithubRepo = 'gunner_githubRepo',
	CreateAndRunTask = 'copilot_createAndRunTask',
	CreateDirectory = 'gunner_createDirectory',
	RunVscodeCmd = 'gunner_runVscodeCommand',
	EditFilesPlaceholder = 'gunner_editFiles',
	SwitchAgent = 'gunner_switchAgent',
	ResolveMemoryFileUri = 'gunner_resolveMemoryFileUri',
}
