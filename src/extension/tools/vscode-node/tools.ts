...
export class ToolsContribution extends Disposable {
	constructor(
		...
		this._register(vscode.commands.registerCommand('gunner.debug.resetVirtualToolGroups', async () => {
		...
		this._register(vscode.commands.registerCommand('gunner.chat.tools.memory.showMemories', async () => {
		...
		this._register(vscode.commands.registerCommand('gunner.chat.tools.memory.clearMemories', async () => {
