...
describe('ChatSessionWorkspaceFolderService', () => {
	...
	describe('trackSessionWorkspaceFolder', () => {
		...
		it('should trigger cleanup when exceeding MAX_ENTRIES', async () => {
			...
			await extensionContext.globalState.update('gunner.cli.sessionWorkspaceFolders', oldData);
			...
			const data = extensionContext.globalState.get<Record<string, unknown>>('gunner.cli.sessionWorkspaceFolders', {});
	...
	describe('getSessionWorkspaceFolder', () => {
		...
		it('should handle malformed data gracefully', async () => {
			...
			await extensionContext.globalState.update('gunner.cli.sessionWorkspaceFolders', {
	...
	describe('cleanupOldEntries', () => {
		it('should keep newer entries and remove older ones', async () => {
			...
			await extensionContext.globalState.update('gunner.cli.sessionWorkspaceFolders', data);
			...
			const finalData = extensionContext.globalState.get<Record<string, unknown>>('gunner.cli.sessionWorkspaceFolders', {});
