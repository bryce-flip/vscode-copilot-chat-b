 ...
 *    - Under `contributes.commands`: Add the VS Code command (e.g., `gunner.claude.mycommand`)
 ...
 *     readonly commandId = 'gunner.claude.mycommand'; // For Command Palette
 *
